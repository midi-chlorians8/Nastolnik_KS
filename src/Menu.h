...
class Menu
{
    ...
    int16_t verticalPosition = 1;  // Ползунок по вертикали. Для координат где мы находимся в дереве меню 
    int8_t horizontalPosition = 2; // Ползунок по горизонтали. Для координат где мы находимся в дереве меню
    // v0 h1 = rain
